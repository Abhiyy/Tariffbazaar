...
namespace DA.EmailEngine
{
    ...
    { private const int Timeout = 180000;
        ...
        public Mailer()
        {
            ...
            _host = DA.EmailEngine.EmailSettings.Default.MailServer;
            //Port- Represents the port number
            _port = int.Parse(DA.EmailEngine.EmailSettings.Default.Port);
            //MailAuthUser and MailAuthPass - Used for Authentication for sending email
            _user = DA.EmailEngine.EmailSettings.Default.MailAuthUser;
            _pass = DA.EmailEngine.EmailSettings.Default.MailAuthPass;
